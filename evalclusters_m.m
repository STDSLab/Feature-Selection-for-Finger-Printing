function obj = evalclusters_m(X, YorFun, crit,varargin)
%EVALCLUSTERS Evaluate clustering solutions.
%   MODIFIED to use SilhouetteEvaluation_m.
%   Modification author:
%      Kendrick Li [6-8-2018]
%
...
%   Copyright 2013 The MathWorks, Inc.
 ...
 [~,critPos] = internal.stats.getParamVal(crit,...
  ...
  switch critPos
      ...
      case 3 %'Silhouette'
           obj = SilhouetteEvaluation_m(X,YorFun,varargin{:});
